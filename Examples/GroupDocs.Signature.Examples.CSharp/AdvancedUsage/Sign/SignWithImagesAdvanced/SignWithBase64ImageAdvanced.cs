...
namespace GroupDocs.Signature.Examples.CSharp.AdvancedUsage
{
    ...
    public class SignWithBase64ImageAdvanced
    {
        ...
        {
            Console.WriteLine("\n--------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("[Example Advanced Usage] # SignWithBase64ImageAdvanced : Sign document with base64 image\n");
            ...
            string outputFilePath = Path.Combine(Constants.OutputPath, "SignWithBase64ImageAdvanced", fileName);
