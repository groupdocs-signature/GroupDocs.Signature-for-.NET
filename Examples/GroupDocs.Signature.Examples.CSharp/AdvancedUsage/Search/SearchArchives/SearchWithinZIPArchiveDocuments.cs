...
namespace GroupDocs.Signature.Examples.CSharp.AdvancedUsage
{
    ...
    {
        /// <summary>
        /// Search withint the ZIP archive documents with varios search options
        /// </summary>
        public static void Run()
        {
            Console.WriteLine("\n--------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("[Example Advanced Usage] # SearchWithinZIPArchiveDocuments : Search ZIP archive document for varios signatures\n");
