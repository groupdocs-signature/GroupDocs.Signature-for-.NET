...
namespace GroupDocs.Signature.Examples.CSharp.AdvancedUsage
{
    ...
    {
        /// <summary>
        /// Search withint the TAR archive documents with varios search options
        /// </summary>
        public static void Run()
        {
            Console.WriteLine("\n--------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("[Example Advanced Usage] # SearchWithinTARArchiveDocuments : Search TAR archive document for varios signatures\n");
